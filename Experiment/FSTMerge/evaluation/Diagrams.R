...
par(mar=c(6,5,1,2)) 
drawConflictsBarPlot("ReactiveUI", ReactiveUIdf, "topright")
dev.off()

png(filename="./ReactiveUIcl-Barplot.png",width=WIDTH,height=HEIGHT)
par(mar=c(6,5,1,2)) 
drawConflictLinesBarPlot("ReactiveUI", ReactiveUIdf, "topright")
dev.off()

png(filename="./ReactiveUIcf-Barplot.png",width=WIDTH,height=HEIGHT)
par(mar=c(6,5,1,2)) 
drawConflictFilesBarPlot("ReactiveUI", ReactiveUIdf, "topright")
dev.off()

png(filename="./ReactiveUIsc-Barplot.png",width=WIDTH,height=HEIGHT)
par(mar=c(6,5,1,2)) 
drawConflictSemanticBarPlot("ReactiveUI", ReactiveUIdf, "topright")
dev.off()
...
par(mar=c(6,5,1,2))
drawConflictsBarPlot("netty", nettydf, "topright")
dev.off()

png(filename="./nettycl-Barplot.png",width=WIDTH,height=HEIGHT)
par(mar=c(6,5,1,2))
drawConflictLinesBarPlot("netty", nettydf, "topright")
dev.off()

png(filename="./nettycf-Barplot.png",width=WIDTH,height=HEIGHT)
par(mar=c(6,5,1,2))
drawConflictFilesBarPlot("netty", nettydf, "topright")
dev.off()

png(filename="./nettysc-Barplot.png",width=WIDTH,height=HEIGHT)
par(mar=c(6,5,1,2))
drawConflictSemanticBarPlot("netty", nettydf, "topright")
dev.off()
