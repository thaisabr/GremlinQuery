...
class  Config (dict) :
	...
	def from_pyfile(self, filename, silent=False):
        ...
        d.__file__ = filename
        try:
<<<<<<< /mnt/Vbox/FSTMerge/binary/fstmerge_tmp1391205463713/fstmerge_var1_6437136076459652630
            exec(compile(open(filename).read(), filename, 'exec'), d.__dict__)
        except IOError, e:
=======
            execfile(filename, d.__dict__)
        except IOError as e:
>>>>>>> /mnt/Vbox/FSTMerge/binary/fstmerge_tmp1391205463713/fstmerge_var2_7021101365245902408
