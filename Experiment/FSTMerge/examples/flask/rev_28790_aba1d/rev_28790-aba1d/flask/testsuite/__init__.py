...
def setup_path():
    add_to_path(os.path.abspath(os.path.join(        os.path.dirname(__file__), 'test_apps')))
...
<<<<<<< /mnt/Vbox/FSTMerge/binary/fstmerge_tmp1391205414155/fstmerge_var1_5416937561303421642
    except Exception, e:
        print('Error: %s' % e)
=======
    except Exception as e:
        print 'Error: %s' % e
>>>>>>> /mnt/Vbox/FSTMerge/binary/fstmerge_tmp1391205414155/fstmerge_var2_6370056939295577698
