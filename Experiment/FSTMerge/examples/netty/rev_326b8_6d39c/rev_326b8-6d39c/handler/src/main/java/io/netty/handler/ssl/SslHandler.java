...
public  class  SslHandler  extends FrameDecoder 
    ...
    ~~FSTMerge~~ ##FSTMerge## private static final ChannelFutureListener HANDSHAKE_LISTENER = new ChannelFutureListener() {
    ...
    }; ##FSTMerge## private static final ChannelFutureListener HANDSHAKE_LISTENER = new ChannelFutureListener() {
    ...
    private ChannelBuffer unwrap(
        ...
        try {
            ...
            if (outAppBuf.hasRemaining()) {
<<<<<<< /mnt/Vbox/FSTMerge/binary/fstmerge_tmp1390772192302/fstmerge_var1_1887847701572899426
...
>>>>>>> /mnt/Vbox/FSTMerge/binary/fstmerge_tmp1390772192302/fstmerge_var2_63677337788065656
                return frame;
            } else {
                return null;
            }
