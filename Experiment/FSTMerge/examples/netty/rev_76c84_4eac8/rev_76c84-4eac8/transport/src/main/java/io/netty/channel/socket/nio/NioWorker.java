...
public  class  NioWorker  extends AbstractNioWorker {
    ...
    protected void registerTask(AbstractNioChannel channel, ChannelFuture future) {
        ...
        try {
            ...
            if (future != null) {
<<<<<<< /mnt/Vbox/FSTMerge/binary/fstmerge_tmp1390772130448/fstmerge_var1_2695363403693456378
...
=======
                ...
                ((NioSocketChannel) channel).setConnected();
>>>>>>> /mnt/Vbox/FSTMerge/binary/fstmerge_tmp1390772130448/fstmerge_var2_7434882072833232979
                future.setSuccess();
            }
