...
~~FSTMerge~~ version_info = (0, 11, 0, 'dev') ##FSTMerge## version_info = (0, 10, 0, '') ##FSTMerge## version_info = (0, 10, 1, 'dev')

~~FSTMerge~~ __version__ = "0.11" ##FSTMerge## __version__ = "0.10" ##FSTMerge## __version__ = "0.10.1"
