...
~~FSTMerge~~ version_info = (0, 11, 0, 'dev') ##FSTMerge## version_info = (0, 10, 3, 'dev') ##FSTMerge## version_info = (0, 10, 4, 'dev')

~~FSTMerge~~ __version__ = "0.11" ##FSTMerge## __version__ = "0.10.3" ##FSTMerge## __version__ = "0.10.4"
